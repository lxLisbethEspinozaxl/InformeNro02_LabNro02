...
pertenecen los empleados.
	...
	\begin{center}
	\includegraphics[width=8cm]{./Imagenes/actividad_03_02}
	\end{center}
	...
	\\
	\begin{center}
	\includegraphics[width=15cm]{./Imagenes/activ3_3} 
	\end{center}
	
	\begin{center}
	\includegraphics[width=8cm]{./Imagenes/ejercicio3-3} 
	\end{center}

	\item Probar la vista, tratando de reasignar al empleado Matos al departamento 80.
	\\
	\begin{center}
	\includegraphics[width=12cm]{./Imagenes/activ3_4} 
	\end{center}
	\begin{center}
	\includegraphics[width=8cm]{./Imagenes/ejercicio3-4} 
	\end{center}
